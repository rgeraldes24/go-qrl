...
#### Sign QRL typed structured data

Signs a [QRL Typed Structured Data v1](../../docs/qrl-typed-structured-data-v1.md)
digest with ML-DSA-87. This is a native VM64 format, not EIP-712. The response
includes the public key and wallet descriptor because an ML-DSA signature does
not support public-key recovery.

The request domain must use the exact `QRLTypedDataDomain` declaration, and its
`chainId` must match Clef's configured chain ID.

#### Arguments

- account [address]: account to sign with
- data [object]: QRL Typed Structured Data v1 object

#### Result

- version [string]: typed-data envelope version
- algorithm [string]: signature algorithm
- address [address]: claimed signer address
- digest [data]: 32-byte typed-data digest
- publicKey [data]: 2592-byte ML-DSA-87 public key
- descriptor [data]: 3-byte QRL wallet descriptor
- signature [data]: 4627-byte ML-DSA-87 signature
...
```json
{
  ...
  "params": [
    "Q0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f40",
    {
      "types": {
        "QRLTypedDataDomain": [
      ...
      "domain": {
        ...
        "version": "1",
        "chainId": "1337",
        "verifyingContract": "Q11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111",
        "salt": "0x000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f"
      },
      "message": {
        "to": "Q403f3e3d3c3b3a393837363534333231302f2e2d2c2b2a292827262524232221201f1e1d1c1b1a191817161514131211100f0e0d0c0b0a090807060504030201",
        "amount": "1",
        "nonce": "42",
        "deadline": "2000000000"
      }
...
Response fields are abbreviated below; production values have the exact byte
...
```json
{
  ...
  "result": {
    "version": "1",
    "algorithm": "ML-DSA-87",
    "address": "Q0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f40",
    "digest": "0x...",
    "publicKey": "0x...",
    "descriptor": "0x...",
    "signature": "0x..."
