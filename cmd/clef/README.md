...
* One critical component (the Clef binary / daemon) is responsible for handling cryptographic operations: signing, wallet seed/key material, encryption/decryption of keystore files.
...
The signer will generate new ML-DSA wallet key material, encrypt the wallet seed in the keystore format, and store it in the keystore directory.
...
#### Result
  - address [string]: account address that is derived from the generated wallet key material
...
#### Result
  - array with account records:
     - account.address [string]: account address that is derived from the generated wallet key material
