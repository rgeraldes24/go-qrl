...
class StdIOHandler:
    ...
    def approveTx(self, req):
        ...
        {"jsonrpc":"2.0","id":20,"method":"ui_approveTx","params":[{"transaction":{"from":"Q00000000000000000000000000000000000000000000000000000000DEADbEeF000000000000000000000000DeaDbeEf","to":"Q00000000000000000000000000000000000000000000000000000000DEADbEeF000000000000000000000000DeaDbeEf","gas":"0x3e8","maxFeePerGas":"0x5","maxPriorityFeePerGas":"0x0","value":"0x6","nonce":"0x1","data":"0x"},"call_info":null,"meta":{"remote":"clef binary","local":"main","scheme":"in-proc","User-Agent":"","Origin":""}}]}
    ...
    def approveSignData(self, req):
        ...
        {"jsonrpc":"2.0","id":8,"method":"ui_approveSignData","params":[{"content_type":"application/x-clique-header","address":"Q000000000000000000000000000000000000000000000000000000000011223344556677889900112233445566778899","raw_data":"","messages":[{"name":"Clique header","value":"clique header 1337 [0x44381ab449d77774874aca34634cb53bc21bd22aef2d3d4cf40e51176cb585ec]","type":"clique"}],"call_info":null,"hash":"0xa47ab61438a12a06c81420e308c2b7aae44e9cd837a5df70dd021421c0f58643","meta":{"remote":"clef binary","local":"main","scheme":"in-proc","User-Agent":"","Origin":""}}]}
        """  # noqa: E501
        message = (
            "Sign data request:\n"
            "\t{meta_string}\n"
    ...
    def onSignerStartup(self, req):
        ...
        {"jsonrpc":"2.0", "method":"ui_onSignerStartup", "params":[{"info":{"extapi_http":"n/a","extapi_ipc":"/home/user/.clef/clef.ipc","extapi_version":"7.0.0","intapi_version":"7.0.1"}}]}
        """  # noqa: E501
        message = (
            "\n"
