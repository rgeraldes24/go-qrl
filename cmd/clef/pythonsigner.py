...
class StdIOHandler:
    ...
    def approveSignData(self, req):
        ...
        {"jsonrpc":"2.0","id":8,"method":"ui_approveSignData","params":[{"content_type":"text/plain","address":"Q000000000000000000000000000000000000000000000000000000000011223344556677889900112233445566778899","raw_data":"GVFSTCBTaWduZWQgTWVzc2FnZToKMTFoZWxsbyB3b3JsZA==","messages":[{"name":"message","value":"\u0019QRL Signed Message:\n11hello world","type":"text/plain"}],"call_info":null,"hash":"0x097ef4cb29183eb6814a1e1ac8bac8d4110e68c73c1d8673c03d79b109fae7c1","meta":{"remote":"clef binary","local":"main","scheme":"in-proc","User-Agent":"","Origin":""}}]}
        """  # noqa: E501
        message = (
            "Sign data request:\n"
            "\t{meta_string}\n"
