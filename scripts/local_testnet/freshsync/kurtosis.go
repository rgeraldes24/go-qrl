...
func (k kurtosis) inspect(ctx context.Context, service string) (rawServiceConfig, error) {
...
func (k kurtosis) add(ctx context.Context, service string, cfg rawServiceConfig) error {
...
func (k kurtosis) remove(ctx context.Context, service string) error {
	_, err := k.runner.run(ctx, nil, "service", "rm", k.enclave, service)
	return err
}

func (k kurtosis) logs(ctx context.Context, service string) (string, error) {
