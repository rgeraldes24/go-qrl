...
readonly FIXTURE_SOURCE="scripts/testing/e2e/testdata/contracts/EventEmitter.hyp"
...
compare_artifact "${REPO_ROOT}/scripts/testing/e2e/suites/goabi/emitter_binding.go" \
...
(
	cd "${REPO_ROOT}/scripts/testing/e2e"
	go test -count=1 ./suites/goabi
)
