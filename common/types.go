...
// zero-padding || hash. This matches how LOG opcodes serialize PUSH32 values
// into 512-bit topic words.
...
// MustParseAddress returns Address with byte values of s, panicking if s
// is not a valid QRL address.
