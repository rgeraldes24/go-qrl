...
var qrlLogTopicFormatter = function(topic) {
	...
	var hex = topic.slice(2);
	// A 32-byte value in topic position is a Keccak hash and occupies the
	// high half of the VM64 topic. Other short values are numeric and remain
	// right-aligned.
	if (hex.length === 64) {
