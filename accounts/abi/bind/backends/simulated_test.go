...
const abiBin = `0x6033600c60003960336000f36020600052600b6020527f68656c6c6f20776f726c6400000000000000000000000000000000000000000060405260606000f3`
const deployedCode = `6020600052600b6020527f68656c6c6f20776f726c6400000000000000000000000000000000000000000060405260606000f3`
...
func TestEstimateGasWithPrice(t *testing.T) {
	...
	recipient := common.BytesToAddress(common.Hex2Bytes("deadbeef"))
	var cases = []struct {
		name        string
		message     qrl.CallMsg
		expect      uint64
