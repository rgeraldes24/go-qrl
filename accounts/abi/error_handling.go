...
var (
	...
	ErrUnsupportedFunctionType = errors.New("abi: function type is unsupported in VM64 because address64 + selector4 is 68 bytes and no canonical one-slot encoding exists")
)
