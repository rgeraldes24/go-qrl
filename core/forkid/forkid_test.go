...
func TestCreation(t *testing.T) {
	...
	tests := []struct {
		...
		// Mainnet test cases
		{
			...
			[]testcase{
				{0, 0, ID{Hash: checksumToBytes(0xb58fd32a), Next: 0}},
...
func TestValidation(t *testing.T) {
	tests := []struct {
		...
		{params.MainnetChainConfig, 15050000, 20000000, ID{Hash: checksumToBytes(0xb58fd32a), Next: 0}, nil},
		...
		{params.MainnetChainConfig, 15050000, 20000000, ID{Hash: checksumToBytes(0xb58fd32a), Next: math.MaxUint64}, nil},

		// Local is mainnet Zond, and isn't aware of more forks. Remote announces Zond +
		// 0xffffffff. Local needs software update, reject.
		{params.MainnetChainConfig, 20000000, 1681338455, ID{Hash: checksumToBytes(checksumUpdate(0xb58fd32a, math.MaxUint64)), Next: 0}, ErrLocalIncompatibleOrStale},
		...
		{params.MainnetChainConfig, 88888888, 8888888888, ID{Hash: checksumToBytes(0xb58fd32a), Next: 8888888888}, ErrLocalIncompatibleOrStale},
	}
	for i, tt := range tests {
